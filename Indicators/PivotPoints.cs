...
namespace OsEngine.Charts.CandleChart.Indicators
{
    public class PivotPoints: IIndicatorCandle
    {
       ...
       // private List<Candle> GetLastFullDay(List<Candle> newCandles)
        //{
        //    LastFullDay = new List<Candle>();

        //    bool flag = false;

        //    for (int i = newCandles.Count - 1; i > 2; i--)
        //    {
        //        if (newCandles[i].TimeStart.Day !=
        //            newCandles[i - 1].TimeStart.Day || flag)
        //        {
        //            flag = true;
        //            LastFullDay.Add(newCandles[i - 1]);

        //            if (newCandles[i - 1].TimeStart.Day != newCandles[i - 2].TimeStart.Day)
        //            {
        //                break;
        //            }
        //        }
