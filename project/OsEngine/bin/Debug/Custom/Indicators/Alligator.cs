...
namespace OsEngine.Indicators.Script
{
    public class Alligator : Aindicator
    {
        private IndicatorParameterInt _lenghtTeeth;
        private IndicatorParameterInt _lenghtLips;
        private IndicatorParameterInt _lenghtJaw;
        ...
        public override void OnStateChange(IndicatorState state)
        {
            ...
            {
                _lenghtJaw = CreateParameterInt("Jaw length", 13);
                _lenghtLips = CreateParameterInt("Lips length", 8);
                _lenghtTeeth = CreateParameterInt("Teeth length", 5);
