...
namespace OsEngine.Robots
{
    ...
    public class StrategyPriceChannelAndFI : BotPanel
    {
        ...
        public StrategyPriceChannelAndFI(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            _buyValue = CreateParameter("Buy Value", 50, 0.1m, 100, 1, "Indicator");
            _sellValue = CreateParameter("Sell Value", 50, 0.1m, 100, 1, "Indicator");
            ...
            Description = OsLocalization.Description.DescriptionLabel269;
        }
        ...
        private void LogicOpenPosition(List<Candle> candles)
        {
            ...
            if (openPositions == null || openPositions.Count == 0)
            {
                ...
                {
                    if (_lastFI > _buyValue.ValueDecimal && _prevUpPC < lastPrice)
                    {
                ...
                {
                    if (_lastFI < -_sellValue.ValueDecimal && _prevDownPC > lastPrice)
                    {
