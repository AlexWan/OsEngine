...
The trend robot on Overbougth Oversold CMO.
...
{
    [Bot("OverbougthOversoldCMO")] // We create an attribute so that we don't write anything to the BotFactory
    public class OverbougthOversoldCMO : BotPanel
    {
        ...
        public OverbougthOversoldCMO(string name, StartProgram startProgram) : base(name, startProgram)
        {
