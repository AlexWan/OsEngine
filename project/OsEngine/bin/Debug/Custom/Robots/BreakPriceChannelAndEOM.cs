...
namespace OsEngine.Robots.AO
{
    ...
    public class BreakPriceChannelAndEOM : BotPanel
    {
        ...
        public BreakPriceChannelAndEOM(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            // Indicator Settings
            _lengthEom = CreateParameter("Length Eom", 10, 1, 50, 1, "Indicator");
            ...
            _period = CreateParameter("Period", 10, 10, 1000, 10, "Indicator");
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < _pcUpLength.ValueInt ||
                ...
                candles.Count < _period.ValueInt)
            {
                return;
            }
        ...
        private void LogicOpenPosition(List<Candle> candles)
        {
            ...
            if (openPositions == null || openPositions.Count == 0)
            {
                ...
                {
                    if (lastPrice > _prevUpPC && MaxValueOnPeriodInddicator(value, _period.ValueInt) < _lastEOM)
                    {
                ...
                {
                    if (lastPrice < _prevDownPC && MinValueOnPeriodInddicator(value, _period.ValueInt) > _lastEOM)
                    {
