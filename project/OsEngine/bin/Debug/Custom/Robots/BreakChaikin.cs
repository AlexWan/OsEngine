...
The trend robot on BreakChaikin.
...
{
    [Bot("BreakChaikin")] // We create an attribute so that we don't write anything to the BotFactory
    public class BreakChaikin : BotPanel
    {
        ...
        public BreakChaikin(string name, StartProgram startProgram) : base(name, startProgram)
        {
