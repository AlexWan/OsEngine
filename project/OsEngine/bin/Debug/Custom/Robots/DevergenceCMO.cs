...
namespace OsEngine.Robots.AO
{
    ...
    public class DevergenceCMO : BotPanel
    {
        ...
        private StrategyParameterInt PeriodCMO;

        // Indicator
        Aindicator _ZigZag;
        Aindicator _ZigZagCMO;
        ...
        public DevergenceCMO(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            PeriodCMO = CreateParameter("Period CMO", 3, 10, 300, 10, "Indicator");
            ...
            ((IndicatorParameterInt)_ZigZagCMO.Parameters[0]).ValueInt = PeriodCMO.ValueInt;
            ((IndicatorParameterInt)_ZigZagCMO.Parameters[1]).ValueInt = PeriodZigZag.ValueInt;
            _ZigZagCMO.Save();
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < PeriodCMO.ValueInt || candles.Count < PeriodZigZag.ValueInt)
            {
                return;
            }
