...
namespace OsEngine.Robots.AO
{
    ...
    public class DevergenceFI : BotPanel
    {
        ...
        private StrategyParameterInt PeriodFI;

        // Indicator
        Aindicator _ZigZag;
        Aindicator _ZigZagFI;
        ...
        public DevergenceFI(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            PeriodFI = CreateParameter("Period FI", 10, 10, 300, 10, "Indicator");
            ...
            ((IndicatorParameterInt)_ZigZagFI.Parameters[0]).ValueInt = PeriodFI.ValueInt;
            ((IndicatorParameterInt)_ZigZagFI.Parameters[1]).ValueInt = PeriodZigZag.ValueInt;
            _ZigZagFI.Save();
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < PeriodFI.ValueInt || candles.Count < PeriodZigZag.ValueInt)
            {
                return;
            }
