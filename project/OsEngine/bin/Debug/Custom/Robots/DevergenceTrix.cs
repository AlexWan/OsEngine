...
namespace OsEngine.Robots.AO
{
    ...
    public class DevergenceTrix : BotPanel
    {
        ...
        public DevergenceTrix(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            ((IndicatorParameterInt)_ZigZagTrix.Parameters[0]).ValueInt = PeriodTrix.ValueInt;
            ((IndicatorParameterInt)_ZigZagTrix.Parameters[1]).ValueInt = PeriodZigZag.ValueInt;
            _ZigZagTrix.Save();
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < PeriodTrix.ValueInt ||
