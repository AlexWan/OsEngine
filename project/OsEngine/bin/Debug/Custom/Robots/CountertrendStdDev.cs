    ...
    public class CountertrendStdDev : BotPanel
    {
        ...
        private void LogicOpenPosition(List<Candle> candles)
        {
            ...
            if (openPositions == null || openPositions.Count == 0)
            {
                ...
                {
                    if (_lastSD > _minValue.ValueDecimal && candles[candles.Count - 1].IsDown && candles[candles.Count - 2].IsDown)
                    {
                ...
                {
                    if (_lastSD > _minValue.ValueDecimal && candles[candles.Count - 1].IsUp && candles[candles.Count - 2].IsUp)
                    {
                        var time = candles.Last().TimeStart;
