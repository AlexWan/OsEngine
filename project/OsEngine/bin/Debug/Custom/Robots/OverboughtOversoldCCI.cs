...
The trend robot on Overbought Oversold CCI.
...
{
    [Bot("OverboughtOversoldCCI")] // We create an attribute so that we don't write anything to the BotFactory
    public class OverboughtOversoldCCI : BotPanel
    {
        ...
        public OverboughtOversoldCCI(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        private void LogicOpenPosition(List<Candle> candles)
        {
            ...
            if (openPositions == null || openPositions.Count == 0)
            {
                ...
                {
                    if (_lastCCI < -_buyValue.ValueDecimal)
                    {
                ...
                {
                    if (_lastCCI > _sellValue.ValueDecimal)
                    {
