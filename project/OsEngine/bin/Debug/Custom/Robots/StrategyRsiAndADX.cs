...
namespace OsEngine.Robots
{
    ...
    public class StrategyRsiAndADX : BotPanel
    {
        ...
        // Exit setting
        private StrategyParameterInt _trailingCandles;
        ...
        public StrategyRsiAndADX(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            // Indicator settings
            _periodRSI = CreateParameter("Period RSI", 14, 10, 300, 10, "Indicator");
            ...
            // Exit setting
            _trailingCandles = CreateParameter("TrailingCandles", 1, 5, 200, 5, "Exit");
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < _periodADX.ValueInt || candles.Count < _periodRSI.ValueInt)
            {
                return;
            }
        ...
        {
            if (candles == null || index < _trailingCandles.ValueInt)
            {
                return 0;
            }
            ...
            if (side == Side.Buy)
            {
                ...
                for (int i = index; i > index - _trailingCandles.ValueInt; i--)
                {
