...
namespace OsEngine.Robots
{
    ...
    internal class StrategyDpoAndAlligator : BotPanel
    {
        ...
        public StrategyDpoAndAlligator(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            _alligatorFastLineLength = CreateParameter("Period Simple Moving Fast", 10, 10, 300, 10, "Indicator");
            _alligatorMiddleLineLength = CreateParameter("Period Simple Moving Average Middle", 20, 10, 300, 10, "Indicator");
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < _dpoLength.ValueInt ||
                candles.Count < _alligatorSlowLineLength.ValueInt + 10)
            {
                return;
            }
