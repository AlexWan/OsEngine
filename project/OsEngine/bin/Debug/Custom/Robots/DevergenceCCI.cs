...
namespace OsEngine.Robots
{
    ...
    public class DevergenceCCI : BotPanel
    {
        ...
        public DevergenceCCI(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            _periodCCI = CreateParameter("Period CCI", 10, 10, 300, 10, "Indicator");
            ...
            ((IndicatorParameterInt)_zigZagCCI.Parameters[0]).ValueInt = _periodCCI.ValueInt;
            ((IndicatorParameterInt)_zigZagCCI.Parameters[1]).ValueInt = _periodZigZag.ValueInt;
            _zigZagCCI.Save();
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < _periodCCI.ValueInt || candles.Count < _periodZigZag.ValueInt)
            {
                return;
            }
