...
namespace OsEngine.Robots
{
    ...
    public class FractalAndCCI : BotPanel
    {
        ...
        // Exit Settings
        private StrategyParameterInt _trailingValueLong;
        private StrategyParameterInt _trailingValueShort;
        ...
        public FractalAndCCI(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            // Exit Settings
            _trailingValueLong = CreateParameter("Long Exit", 1, 5, 200, 5, "Exit");
            _trailingValueShort = CreateParameter("Short Exit", 1, 5, 200, 5, "Exit");
        ...
        private void LogicClosePosition(List<Candle> candles)
        {
            ...
            for (int i = 0; openPositions != null && i < openPositions.Count; i++)
            {
                ...
                if (pos.Direction == Side.Buy) // If the direction of the position is long
                {
                    ...
                    stopPrice = lov - lov * _trailingValueLong.ValueInt / 100;
                }
