        ...
        private void LogicClosePosition(List<Candle> candles)
        {
            ...
            for (int i = 0; openPositions != null && i < openPositions.Count; i++)
            {
                ...
                if (pos.Direction == Side.Buy) // If the direction of the position is buy
                {
                    ...
                    {
                        _tab.CloseAtProfitMarket(pos, MaxPrice(candles, _profitCandles.ValueInt));
                        _tab.CloseAtStopMarket(pos, MinPrice(candles, _stopCandles.ValueInt));
                    }
                ...
                else // If the direction of the position is sell
                {
                    ...
                    {
                        _tab.CloseAtProfitMarket(pos, MinPrice(candles, _profitCandles.ValueInt));
                        _tab.CloseAtStopMarket(pos, MaxPrice(candles, _stopCandles.ValueInt));
                    }
