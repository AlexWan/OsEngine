...
namespace OsEngine.Robots.Vwma
{
    ...
    public class IntersectionOfTheThreeVwma : BotPanel
    {
        ...
        private StrategyParameterInt _periodVwmaMiddle;
        ...
        public IntersectionOfTheThreeVwma(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            // Indicator Settings
            _periodVwmaFast = CreateParameter("Period VWMA Fast", 100, 10, 300, 1, "Indicator");
            _periodVwmaMiddle = CreateParameter("Period VWMA Middle", 200, 10, 300, 1, "Indicator");
            _periodVwmaSlow = CreateParameter("Period VWMA Slow", 300, 10, 300, 1, "Indicator");
            ...
            ((IndicatorParameterInt)_vwmaMiddle.Parameters[0]).ValueInt = _periodVwmaMiddle.ValueInt;
            _vwmaMiddle.Save();
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < _periodVwmaFast.ValueInt
                || candles.Count < _periodVwmaMiddle.ValueInt
