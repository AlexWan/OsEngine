...
namespace OsEngine.Robots
{
    ...
    public class OverbougthOversoldROC : BotPanel
    {
        ...
        public OverbougthOversoldROC(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            // Indicator settings
            _periodROC = CreateParameter("Period ROC", 13, 10, 300, 1, "Indicator");
            ...
            ((IndicatorParameterInt)_ROC.Parameters[0]).ValueInt = _periodROC.ValueInt;
            _ROC.Save();
            ...
            Description = OsLocalization.Description.DescriptionLabel229;
        }
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            if (candles.Count < _periodROC.ValueInt)
            {
                return;
            }
        ...
        private void LogicOpenPosition(List<Candle> candles)
        {
            ...
            if (openPositions == null || openPositions.Count == 0)
            {
                ...
                {
                    if (_prevROC < _buyValue.ValueDecimal && _lastROC > _buyValue.ValueDecimal)
                    {
                ...
                {
                    if (_prevROC > _sellValue.ValueDecimal && _lastROC < _sellValue.ValueDecimal)
                    {
