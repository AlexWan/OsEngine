    ...
    public class PriceChannelCounterTrend : BotPanel
    {
        ...
        private void LogicClosePosition(List<Candle> candles, Position position)
        {
            ...
            if(position.SignalTypeClose != "StopActivate")
            {
                ...
                { // выставляем первый ордер на закрытие по профиту
                    ...
                    decimal volume = position.MaxVolume / 2;
                    ...
                    _tab.CloseAtLimit(position, price, volume);
                      ...
                      && position.CloseOrders != null
                      && position.CloseOrders.Count == 1)
                { // выставляем второй ордер на закрытие по профиту
