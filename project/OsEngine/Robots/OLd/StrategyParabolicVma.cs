...
{
    public class FreeStylikParabolicVma : BotPanel
    {
        // сервис
        public FreeStylikParabolicVma(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            FreeStylikParabolicVmaUi ui = new FreeStylikParabolicVmaUi(this);
            ui.ShowDialog();
        }
