...
{
    public class Orders_2_LimitsExecute : AServerTester
    {
        ...
        private void SendBuyOrder(Security mySec, decimal price)
        {
            ...
            while (true)
            {
                ...
                if (_ordersFail.Count != 0)
                {
                    this.SetNewError("Error 11. Order FAIL found from server BuyLimit");
                    return;
                }
        ...
        private void SendSellOrder(Security mySec, decimal price)
        {
            ...
            while (true)
            {
                ...
                if (_ordersFail.Count != 0)
                {
                    this.SetNewError("Error 14. Order FAIL found from server SellLimit");
                    return;
                }
            ...
            while (true)
            {
                ...
                if (_ordersFail.Count != 0)
                {
                    this.SetNewError("Error 16. Order FAIL found from server SellLimit");
                    return;
                }
