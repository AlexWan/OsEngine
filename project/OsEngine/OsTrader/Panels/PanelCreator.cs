...
{ 
    ...
    public class Strategy19_27 : BotPanel

    //        --------------------------------------------------------------------
    //Pseudo Source Code of Strategy 19.27
    //    with parameter names.

    //    Generated by StrategyQuant version 3.8.1
    //    Generated at Sat Jun 03 16:23:00 GMT 2017

    //    Tested on SBERP, H1, 05.05.2003 - 11.05.2013
    //    Spread: 3.0, Slippage: 0.0, Min distance of stop from price: 5.0
    //--------------------------------------------------------------------
    //====================================================================
    //== Entry conditions
    //==================================================================== 
    //LongEntryCondition = (BollingerBand_Up(10, 5, 0) > EMA(9))
    ...
    //    if No position is open then Buy at BollingerBand_Up(9, 2, 0) + (0.5 * ATR(77)) Stop;
    //    Stop/Limit order expires after 15 bars.

    //    Stop Loss = 1345 pips;
    //    Profit Target = 1651 pips;

    //    // Stop trailing (on close)
    //    Move Stop to(EMA(21) + (0) * ATR(47))) on bar close;
    //}

    {
        private BotTabSimple _tab;
        private Bollinger _bol_10;
        private Bollinger _bol_9;
        private Atr _atr_77;
        private MovingAverage _ema9;
        public int volume;

        public Strategy19_27(string name) : base(name)
        {
            volume = 1;
        ...
        private decimal _lastBol_10_up;
        private decimal _lastBol_9_up;
        private decimal _lastEma_9;
        private decimal _lastAtr;
        private void TradeLogic(List<Candle> candles)
        {
            _lastPrice = candles[candles.Count - 1].Close;
            _lastBol_10_up = _bol_10.ValuesUp[_bol_10.ValuesUp.Count - 1];
            _lastBol_9_up = _bol_9.ValuesUp[_bol_9.ValuesUp.Count - 1];
            ...
            bool longEntryCondition = (_lastBol_10_up > _lastEma_9);
            if (longEntryCondition && (_tab.PositionsOpenAll == null || _tab.PositionsOpenAll.Count == 0))
            {
                decimal orderOpenLimitPrice = _lastBol_9_up + ((decimal)0.5 * _lastAtr);
                _tab.BuyAtStop(volume, orderOpenLimitPrice, orderOpenLimitPrice, StopActivateType.HigherOrEqual);
            }
    ...
    public class PanelCreator
    {
        ...
        public static BotPanel GetStrategyForName(string nameClass, string name)
        {
            ...
            if (nameClass == "Strategy19_27")
            {
                bot = new Strategy19_27(name);
            }
