...
{
    /// <summary>
    /// Логика взаимодействия для OneLegArbitration.xaml
    /// </summary>
    public partial class OneLegArbitrationUi
    {
        private OneLegArbitration _strategy;
        public OneLegArbitrationUi(OneLegArbitration strategy)
        {
            InitializeComponent();
            _strategy = strategy;
