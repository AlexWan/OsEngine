...
{
    public partial class TesterMarginRatesEditUi
    {
        public TesterMarginRatesEditUi(TesterServer server, List<ListTableSumm> list, int year)
        {
            InitializeComponent();
            ...
            Closed += TesterMarginRatesEditUi_Closed;
        ...
        private void TesterMarginRatesEditUi_Closed(object sender, EventArgs e)
        {
            try
            {
                Closed -= TesterMarginRatesEditUi_Closed;
