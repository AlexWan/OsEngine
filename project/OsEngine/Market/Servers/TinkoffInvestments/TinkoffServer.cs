            ...
            while (true)
            {
                try
                {
                    ...
                    if (tradesResponse.OrderTrades != null)
                    {
                        ...
                        order.Price = order.TypeOrder == OrderPriceType.Limit ? GetValue(state.InitialOrderPrice)/state.LotsRequested : 0;
            ...
            try
            {
                ...
                if (response != null)
                {
                    ...
                    for (int i = 0; i < response.Orders.Count; i++)
                    {
                        ...
                        {
                            newOrder.Price = GetValue(state.InitialOrderPrice)/state.LotsRequested;
                        }
