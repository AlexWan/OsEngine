...
namespace OsEngine.Indicators
{
    ...
    public class ZigZagAsi : Aindicator
    {
        ...
        private IndicatorParameterDecimal _asiLimit;
        ...
        public override void OnStateChange(IndicatorState state)
        {
            ...
            {
                _asiLimit = CreateParameterDecimal("Limit Moves", 10000.0m);
                ...
                ((IndicatorParameterDecimal)_Asi.Parameters[0]).Bind(_asiLimit);
                ProcessIndicator("ASI", _Asi);
        ...
        {
            _seriesAsi.Values[index] = _Asi.DataSeries[0].Values[index];
            ...
            List<decimal> valuesAsi = new List<decimal>();

            for (int i = 0; i < index + 1; i++)
            {
                valuesAsi.Add(values[i]);
            }

            decimal High = 0;
            decimal Low = 0;

            High = valuesAsi[valuesAsi.Count - 1];
            Low = valuesAsi[valuesAsi.Count - 1];
