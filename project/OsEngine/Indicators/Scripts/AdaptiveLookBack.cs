...
namespace OsEngine.Indicators
{
    ...
    public class AdaptiveLookBack : Aindicator
    {
        public override string Description
        {
            get
            {
                string eng = "AdaptiveLookBack analyzes consecutive swing points on the chart and dynamically calculates the optimal lookback period, adapting to the current market structure. " +
                             "Traders use it as an auxiliary tool for selecting the period of other indicators or building adaptive levels, taking into account real oscillation cycles rather than a fixed number of bars.";

                string ru = "AdaptiveLookBack анализирует последовательные свинговые точки на графике и динамически вычисляет оптимальный lookback-период, адаптируясь под текущую рыночную структуру. " +
                            "Трейдеры используют его как вспомогательный инструмент для выбора периода других индикаторов или построения адаптивных уровней, чтобы учитывать реальные циклы колебаний, а не фиксированное число баров.";
        ...
        private decimal GetValue(List<Candle> candles, int index, bool updateOnly)
        {
            ...
            // SwingLo - true, ����: index - 2 => ������ ������ ������ ���� ������. && [index] => � � �������� ������� ��� ����� ��� ������
            // SwingHi - true, ����: index - 2 => ����� ������ ������ ���� ������. && [index] => � � �������� ������� ��� ������ ��� ������
