...
- **Направление:** контанго-арбитраж (лонг база + шорт фьючерс). Режим `OnlyShortFutures` — голый шорт фьючерса без хеджа: та же логика выбора лучшей доходности и перекладывания, но торгуется только фьючерсная нога.
