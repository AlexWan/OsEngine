# OsEngine — Сценарии работы через MCP API V1 (ЛЕГАСИ)

> **ЛЕГАСИ. MCP API V1.** Эти сценарии описывают работу со старой версией API, которая будет **удалена весной 2027 года**. Новые интеграции — только на V2: [`CONTEXT_MCP_V2.md`](CONTEXT_MCP_V2.md) и [`CONTEXT_MCP_SCENARIO_V2.md`](CONTEXT_MCP_SCENARIO_V2.md).
