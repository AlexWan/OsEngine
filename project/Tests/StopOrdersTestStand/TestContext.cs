...
namespace StopOrdersTestStand
{
    ...
    public class TestContext
    {
        ...
        {
            Console.WriteLine("=== Stop Orders Test Stand ===");
        ...
        public void PrintSummary(TimeSpan elapsed)
        {
            ...
            Dictionary<string, int[]> moduleStats = new Dictionary<string, int[]>();
            ...
            foreach (KeyValuePair<string, int[]> pair in moduleStats)
            {
