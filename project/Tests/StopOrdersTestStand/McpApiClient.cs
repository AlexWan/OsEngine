    ...
    public class McpApiClient : IDisposable
    {
        ...
        public HttpResponseMessage SendNotificationRaw(string method, object parameters)
        {
            try
            {
                ...
                HttpRequestMessage httpRequest = new HttpRequestMessage(HttpMethod.Post, $"{BaseUrl}/api/v1/mcp") { Content = content };
        ...
        public string Initialize()
        {
            return SendRequest("initialize", new
            {
                ...
                capabilities = new { },
                clientInfo = new { name = "StopOrdersTestStand", version = "1.0.0" }
            });
        }
